  ...
  plans = signal([
    {
      ...
      recommended: false,
      accent: '#00EAFF',
      background: 'linear-gradient(135deg, rgba(0,234,255,0.18), rgba(3,18,36,0.9))',
      glow: '0 15px 40px rgba(0,234,255,0.25)',
    ...
    },
    {
      ...
      recommended: true,
      accent: '#1F7BFF',
      background: 'linear-gradient(135deg, rgba(31,123,255,0.22), rgba(4,20,52,0.9))',
      glow: '0 20px 45px rgba(31,123,255,0.35)',
    ...
    },
    {
      ...
      recommended: false,
      accent: '#0F4CFF',
      background: 'linear-gradient(135deg, rgba(15,76,255,0.2), rgba(2,16,40,0.9))',
      glow: '0 20px 45px rgba(15,76,255,0.35)',
